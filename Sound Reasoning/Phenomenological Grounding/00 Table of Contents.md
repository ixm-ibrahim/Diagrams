...
Old notes from a discarded first pass, kept only as reference while the fresh derivation replaces them. Each one is deleted when its term is derived fresh; the folder goes when it is empty.
