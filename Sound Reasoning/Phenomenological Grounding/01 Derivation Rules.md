...
## The row every node carries (his format, 2026-09-01)

1. ID — section initials plus a number (Phenomenological Primitives → PP1, PP2, ...)
2. Title
3. Motivation
4. Definition
5. Inherits From
